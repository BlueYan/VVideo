 ...
 * Function:
 */
public class CartoonAdapter extends CommonAdapter<AllRank.VideosBean> {

    private static final String TAG = CartoonAdapter.class.getSimpleName();

    public CartoonAdapter(Context context, List<AllRank.VideosBean> list) {
        super(context, list);
    ...
    @Override
    public void onBindData(SuperViewHolder mHolder, int position, AllRank.VideosBean item) {
